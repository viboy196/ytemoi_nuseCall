...
```
  ...
  C:\esp\.espressif\python_env\idf3.3_py3.8_env\Scripts\python.exe C:\esp\.espressif\esp-adf\esp-idf\components\esptool_py\esptool\esptool.py --chip esp32 --port COM4 --baud 921600 --before default_reset --after hard_reset write_flash -z --flash_mode dio --flash_freq 40m --flash_size detect 0x210000 .\tools\audio_tone.bin
```
